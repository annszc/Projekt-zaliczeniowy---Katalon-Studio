...
<WebElementEntity>
   ...
   <tag></tag>
   <elementGuidId>f458581d-6ea7-475a-b962-ba71f50c3231</elementGuidId>
   <selectorCollection>
      <entry>
         <key>XPATH</key>
         <value>//body[@id='fadein']</value>
      </entry>
      <entry>
         <key>CSS</key>
         <value>#fadein</value>
                            ...
                            Account                            
                             ...
                             Logout
                                    ...
                                    Home
                                                                        ...
                                                                        About Us                                    Terms of Use                                    FAQ                                    How to Book                                                                                                          
...
$(&quot;#hotels-search&quot;).submit(function() {
    ...
    var actionURL = 'hotels/' + language + '/' + 'usd' + '/';
...
Featured Tours
            ...
            Your browser does not support the video tag.
                    ...
                    New Offers
                    Rate is subject to the prevailing tax and service charge. An additional Tourism service fee will be applied as per every service.
...
May 2023SuMoTuWeThFrSa3012345678910111213141516171819202122232425262728293031123456789102023JanFebMarAprMayJunJulAugSepOctNovDec2020-2029201920202021202220232024202520262027202820292030May 2023SuMoTuWeThFrSa3012345678910111213141516171819202122232425262728293031123456789102023JanFebMarAprMayJunJulAugSepOctNovDec2020-2029201920202021202220232024202520262027202820292030February 2022SuMoTuWeThFrSa3031123456789101112131415161718192021222324252627281234567891011122022JanFebMarAprMayJunJulAugSepOctNovDec2020-2029201920202021202220232024202520262027202820292030February 2022SuMoTuWeThFrSa3031123456789101112131415161718192021222324252627281234567891011122022JanFebMarAprMayJunJulAugSepOctNovDec2020-2029201920202021202220232024202520262027202820292030February 2021SuMoTuWeThFrSa3112345678910111213141516171819202122232425262728123456789101112132021JanFebMarAprMayJunJulAugSepOctNovDec2020-2029201920202021202220232024202520262027202820292030February 2022SuMoTuWeThFrSa3031123456789101112131415161718192021222324252627281234567891011122022JanFebMarAprMayJunJulAugSepOctNovDec2020-2029201920202021202220232024202520262027202820292030February 2022SuMoTuWeThFrSa3031123456789101112131415161718192021222324252627281234567891011122022JanFebMarAprMayJunJulAugSepOctNovDec2020-2029201920202021202220232024202520262027202820292030
...
$ajax.select2({
    ajax: {
        url: &quot;https://www.phptravels.net/hotels_locations&quot;,
        dataType: &quot;json&quot;,
        data: function(t) {
            return {
                q: $.trim(t.term)
...
$('#email_subscribe').click(function() { 
    let S_email = $('#exampleInputEmail1').val();
        if(S_email != 0)
        {
            ...
            {$.ajax({type: &quot;GET&quot;,
                url: &quot;https://www.phptravels.net/subscribe&quot;,
...
id(&quot;fadein&quot;)/span[@class=&quot;select2-container select2-container--default select2-container--open&quot;]/span[@class=&quot;select2-dropdown select2-dropdown--below&quot;]/span[@class=&quot;select2-search select2-search--dropdown&quot;]/input[@class=&quot;select2-search__field&quot;]Please enter 3 or more characters</value>
   </webElementProperties>
   <webElementProperties>
      <isSelected>false</isSelected>
      <matchCondition>equals</matchCondition>
   ...
   <webElementXpaths>
      ...
      <type>Main</type>
      <value>//body[@id = 'fadein' and (text() = concat(&quot;
...
id(&quot;fadein&quot;)/span[@class=&quot;select2-container select2-container--default select2-container--open&quot;]/span[@class=&quot;select2-dropdown select2-dropdown--below&quot;]/span[@class=&quot;select2-search select2-search--dropdown&quot;]/input[@class=&quot;select2-search__field&quot;]Please enter 3 or more characters&quot;) or . = concat(&quot;
