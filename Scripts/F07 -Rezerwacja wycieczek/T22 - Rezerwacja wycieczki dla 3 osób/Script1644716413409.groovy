...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_big bus tour of dubai - PHPTRAVELS/select_1                          2        _935183'), 
    '3', true)

WebUI.click(findTestObject('Object Repository/Page_big bus tour of dubai - PHPTRAVELS/span_Book Now'))

WebUI.setText(findTestObject('Object Repository/Page_Booking Big Bus Tour of Dubai - PHPTRAVELS/input_First Name_firstname_1'), 
    'Demo')

WebUI.setText(findTestObject('Object Repository/Page_Booking Big Bus Tour of Dubai - PHPTRAVELS/input_Last Name_lastname_1'), 
    'User')

WebUI.setText(findTestObject('Object Repository/Page_Booking Big Bus Tour of Dubai - PHPTRAVELS/input_First Name_firstname_2'), 
    'Demo')

WebUI.setText(findTestObject('Object Repository/Page_Booking Big Bus Tour of Dubai - PHPTRAVELS/input_Last Name_lastname_2'), 
    'User2')
