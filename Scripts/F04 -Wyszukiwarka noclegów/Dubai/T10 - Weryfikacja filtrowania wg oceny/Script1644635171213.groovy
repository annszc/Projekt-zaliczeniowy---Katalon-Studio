...
WebUI.click(findTestObject('Search/stars3_check'))

WebUI.takeScreenshot()

WebUI.click(findTestObject('Search/stars3_check'))

WebUI.click(findTestObject('Search/stars4_check'))

WebUI.takeScreenshot()

WebUI.click(findTestObject('Search/stars4_check'))

WebUI.click(findTestObject('Search/stars5_check'))

WebUI.takeScreenshot()

WebUI.click(findTestObject('Search/stars5_check'))

WebUI.click(findTestObject('Search/stars2_check'))

WebUI.takeScreenshot()

WebUI.click(findTestObject('Search/stars2_check'))

WebUI.click(findTestObject('Search/stars1_check'))
