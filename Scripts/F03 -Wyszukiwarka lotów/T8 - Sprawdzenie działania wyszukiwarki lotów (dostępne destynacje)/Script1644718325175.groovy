...
WebUI.click(findTestObject('Object Repository/Search/Page_Search Hotels - PHPTRAVELS/div_Dubai, United Arab Emirates'))
...
WebUI.verifyElementNotPresent(findTestObject('Search/no result'), 30)
