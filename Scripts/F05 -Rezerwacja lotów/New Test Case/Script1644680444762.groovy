...
WebUI.click(findTestObject('Object Repository/Page_Search Hotels - PHPTRAVELS/h6_Etihad Airways'))

WebUI.click(findTestObject('Object Repository/Page_Flights - PHPTRAVELS/strong_USD 79.2'))
...
WebUI.click(findTestObject('menu_my account'))
